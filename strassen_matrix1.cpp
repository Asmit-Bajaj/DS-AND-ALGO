...
int ** strassen(int n,int **A,int **B,int r,int c,int r1,int c1){
        ...
        int **temp = strassen(n/2,M,N,0,0,0,0);
        int **temp1 = strassen(n/2,M,N,0,n/2,n/2,0);
        ...
        temp = strassen(n/2,M,N,0,0,0,n/2);
        temp1 = strassen(n/2,M,N,0,n/2,n/2,n/2);
        ...
        temp = strassen(n/2,M,N,n/2,0,0,0);
        temp1 = strassen(n/2,M,N,n/2,n/2,n/2,0);
        ...
        temp = strassen(n/2,M,N,n/2,0,0,n/2);
        temp1 = strassen(n/2,M,N,n/2,n/2,n/2,n/2);
...
int main()
{
        ...
        arr2 = strassen(n,arr,arr1,0,0,0,0);
